    ...
    return (
        <div className="mx-auto flex flex-col md:flex-row bg-cover bg-no-repeat md:p-4 p-2 justify-between h-auto w-full"
         style={{ backgroundImage: "url('footer.webp')"}}>
            <div>
                <h1 className="text-xs md:text-center md:text-sm text-gray-400">Email </h1>
            ...
            <div>
                <h1 className="text-xs md:text-center md:text-sm text-gray-400 mt-4 md:mt-0">Get Connected</h1>
            ...
            <div>
                <p className="mx-auto text-xs md:text-gray-400 text-white mt-4 md:mt-0"> © Designed by Jyoti Patel <br /> All rights reserved.</p>
            </div>
        </div>
    )
}
